...
const KATEGORIE_DATA: Record<string, { title: string; h1: string; description: string; seoText: string }> = {
  ...
  "freie-waffen": {
    title: "Freie Waffen kaufen Schweiz",
    h1: "Freie Waffen kaufen & verkaufen in der Schweiz",
    description: "Alle freien Waffen in der Schweiz. Luftgewehre, CO2-Waffen und Schreckschusswaffen auf GunMarket.ch.",
    seoText: "Entdecken Sie auf GunMarket.ch freie Waffen, die ohne Waffenerwerbsschein erworben werden können. Dazu gehören Luftdruckwaffen, CO2-Waffen und Schreckschusswaffen gemäss Art. 10 des Schweizer Waffengesetzes. Diese Waffen können von jeder Person ab 18 Jahren frei erworben werden. Auf GunMarket.ch finden Sie eine grosse Auswahl an freien Waffen für Sport, Freizeit und Training.",
  },
  zubehoer: {
