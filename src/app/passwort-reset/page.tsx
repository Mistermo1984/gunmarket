    ...
    return (
      <div className="flex min-h-[calc(100vh-64px)] items-center justify-center px-4">
        <div className="text-center">
          <p className="mb-4 text-sm text-neutral-500">Ungültiger Link.</p>
          <Link href="/passwort-vergessen" className="text-sm font-medium text-brand-green hover:underline">
  ...
  return (
    <div className="flex min-h-[calc(100vh-64px)] items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-green-light">
          <Lock size={28} className="text-brand-green" />
        </div>

        <h1 className="mb-2 text-center font-display text-2xl font-black text-brand-dark">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="passwordConfirm" className="mb-1.5 block text-sm font-medium text-brand-dark">
              Passwort bestätigen
            </label>
            <input
              id="passwordConfirm"
